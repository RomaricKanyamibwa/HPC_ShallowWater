...
//    if(my_rank==0)
//    {
//        memcpy(hfil_buff_recv,hfil_buff_send,size_x/Nbli*size_y/NbCol*sizeof(double));
//        for(i=0;i<NP-1;i++)
//        {
...
//            MPI_Recv(hfil_buff_recv+size_x/NbLi*size_y/NbCol*status.MPI_SOURCE
...
//        MPI_Send(hfil_buff_send,size_y/NbCol*size_x/NbLi,MPI_DOUBLE,0,TAG_GATHER,MPI_COMM_WORLD);
